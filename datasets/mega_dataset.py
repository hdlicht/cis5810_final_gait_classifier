...
def process_clip_for_inference(mp_features, dino_features, sequence_length, downsample_factor):
    ...
    dino_features = normalize_signal(dino_features)
    
    features = torch.cat([mp_features, dino_features], dim=1)
        ...
        for clip in self.clips:
            ...
            for file_name in files:
                ...
                for i in range(0, len(mp_features), total_fps):
                    ...
                    fft_features = get_fft_features(chunk_mp, total_fps, max_freq=1)  # Adjust max_freq if necessary
